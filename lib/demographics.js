function get_demographics(timeline){
    ...
    var demographics_two = { 
        ...
        on_finish: function(data) {
            ...
            } else { // if null because we turned demographics off
                jatos.studySessionData["handedness"] = 'right';
                console.log("this is undefined, probably because you turned off demographics---defaulting to right handedness");
            }
        },
    }
